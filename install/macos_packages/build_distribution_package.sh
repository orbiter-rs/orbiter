...
usage() {
  ...
  echo "    - A orbiter component package"
...
productbuild --synthesize --package orbiter-component.pkg --product "$archplist" orbiter_raw.dist
...
productbuild --distribution orbiter.dist --resources "$resources" --package-path "$component_package" orbiter-unsigned.pkg
